...
class CoreTest(unittest.TestCase):
    ...
    def test_single_bsp_tree(self):
        ...
        mesh_lifang: o3d.open3d_pybind.geometry.TriangleMesh = o3d.geometry.TriangleMesh.create_box(5, 5, 5).translate(
            (8, 0, 0))
    ...
    def test_bsp_tree_check_in(self):
        """
        测试bsp 树的基于点的碰撞检测效果
        :return:
        """

        mesh_lifang: o3d.open3d_pybind.geometry.TriangleMesh = o3d.geometry.TriangleMesh.create_box(5, 5, 5)
        mesh_lifang.compute_vertex_normals()
        tree_lifang = create_bsp_tree_with_triangle_mesh(mesh_lifang)
